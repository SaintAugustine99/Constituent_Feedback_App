...
class Command(BaseCommand):
    help = 'Loads Kenyan administrative data (Counties, Constituencies, Wards) into the database'
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f"✅ DONE! Successfully imported all Kenyan administrative data."))
